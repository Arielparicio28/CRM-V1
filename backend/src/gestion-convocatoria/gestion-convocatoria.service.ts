...
export class GestionConvocatoriaService {
 ...
 async findOne(id:ObjectId) {
  ...
  async update(id: string, updateGestionConvocatoriaDto: UpdateGestionConvocatoriaDto) {
    try {
      const updatedGestion = await this.GestionModel.findByIdAndUpdate(id, updateGestionConvocatoriaDto, {
        new: true, 
      })
      if (!updatedGestion) {
